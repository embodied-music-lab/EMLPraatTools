...
## EML Stats & Graphs is coming soon

EML Stats & Graphs aims to solve multiple challenges for voice researches using the Praat environment for analysis, statistics, and graphing.
...
imports the core, and the core never reaches back into it. See
`plugin/dev/ARCHITECTURE.md` for the rules that govern the boundary.
