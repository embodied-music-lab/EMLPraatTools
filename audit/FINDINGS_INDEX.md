...
| D93 | CLARITY  | high  | [L4173](DRIVE_FINDINGS_2026-08-04.md#L4173) | Each wrapper entry form is a leaf: the menu selection IS the navigation, so an error naming a different tool leaves no route to it and the only exit is Quit. First statement described the error dialog and field reset — CORRECTED at L4250 to the structural defect | 4250 |
