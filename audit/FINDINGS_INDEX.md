...
| D91 | GRAPHING  | medium  | [L3890](DRIVE_FINDINGS_2026-08-04.md#L3890) | The histogram frequency axis cannot be made data-derived without a tick constraint on `@emlDrawAxes`; two attempts backed out, both evidenced. 15 of 17 axis-range sites are now adaptive | — |
