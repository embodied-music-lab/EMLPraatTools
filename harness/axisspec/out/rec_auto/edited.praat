...
axisYMin     = 120   ; the y-axis range -- AUTO (both 0 = computed from the data) -- run 1, step 1 (draw)
axisYMax     = 500   ; on the recorded data this resolved to 140.0000 .. 320.0000; auto adapts to other data
