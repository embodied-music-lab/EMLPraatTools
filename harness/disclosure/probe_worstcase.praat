...
#
# Writes <EML_OUT>/worst_bar.png and worst_scatter.png and prints
# the line counts.
# ---------------------------------------------------------------------------
...
Save as 300-dpi PNG file: probeOut$ + "/worst_bar.png"
...
@emlAssertFullViewport
Save as 300-dpi PNG file: probeOut$ + "/worst_scatter.png"
