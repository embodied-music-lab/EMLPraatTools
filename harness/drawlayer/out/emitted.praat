...
# draw layer  --  recorded on Praat 6.6.30
# Input: narrow -- 60 rows, 2 columns
# ============================================================
...
# ------------------------------------------------------------
# THE OBJECT
# Recorded against: narrow -- 60 rows, 2 columns.
...
#
# Table narrow was already open when this recording started.
...
data1$ = "Table narrow"   ; run 1, step 1 (draw)
...
axisYMax     = 0.0   ; on the recorded data this resolved to 160.0000 .. 340.0000; auto adapts to other data
...
@emlDrawViolinPlot: data, "Auto axis", "Group", "Power (dB)", 6, 4, "color", 1, groupCol$, valueCol$, axisYMin, axisYMax

# Axis resolved to 160.0000 .. 340.0000 over 3 groups on the recorded data; auto adapts to other data.
