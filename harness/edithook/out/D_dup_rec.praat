...
# Input: Table demo -- 3 rows, 3 columns
# ============================================================
...
# ------------------------------------------------------------
# THE OBJECT
# Recorded against: Table demo -- 3 rows, 3 columns.
...
selectObject: data1$
data = selected ()
# Changed colA in row 1 from B1 to ZZZ
# This step changes the table in memory.
# Nothing here writes back to the file the table came from.

Rename column (by number): 3, "eml_col_lock"
Set string value: 1, "eml_col_lock", "ZZZ"
