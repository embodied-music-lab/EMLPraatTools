...
# Input: Table demo -- 2 rows, 2 columns
# ============================================================
...
# ------------------------------------------------------------
# THE OBJECT
# Recorded against: Table demo -- 2 rows, 2 columns.
...
selectObject: data2$
data = selected ()
# Named column 2, which had no name, Column_2
# This step changes the table in memory.
# Nothing here writes back to the file the table came from.

Rename column (by number): 2, "Column_2"
...
selectObject: data3$
data = selected ()
# Changed Column_1 in row 1 from  to named
# This step changes the table in memory.
# Nothing here writes back to the file the table came from.

Set string value: 1, "Column_1", "named"
