...
data1$ = "Table fa"   ; run 1, steps 1 (analysis), 2 (draw)
...
axisYMin  = 150   ; the y-axis range -- as typed in the dialog -- run 1, step 2 (draw)
axisYMax  = 400   ; the figure was drawn on 150.0000 .. 612.0032
...
# Axis resolved to 150.0000 .. 612.0032 over 4 groups.
# The same step through the menu:
