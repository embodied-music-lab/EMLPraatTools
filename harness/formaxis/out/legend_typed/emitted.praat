...
#
# Table fa was already open when this recording started.
...
data1$ = "Table fa"   ; run 1, step 1 (draw)
...
axisYMin     = 100   ; the y-axis range -- as typed in the dialog -- run 1, step 1 (draw)
