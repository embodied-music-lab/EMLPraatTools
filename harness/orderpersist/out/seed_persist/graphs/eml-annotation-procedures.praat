                    ...
                    if .useMatrix
                        ...
                        for .i from 1 to .nGroups - 1
                            for .j from .i + 1 to .nGroups
                                ...
                                @emlFormatAnnotLabel: .pairP, undefined, .style$, 0, ""
                                annotMatrixCell'.i'_'.j'$ = emlFormatAnnotLabel.result$
                                # THE FLAG FOLLOWS THE p ACTUALLY PRINTED IN
                                # THE CELL, and an undefined p is not a
                                # comparison: without the guard the cell text
                                # and the cell styling can disagree. This is
                                # the single, careful form of the check,
