...
#   .detail$    what was built, in the wording the user chose it by
...
procedure emlRecordReadStep: .objectId, .path$
    ...
    ... "In the GUI: Praat's own Open menu. This plugin registers no reader "
    ... + "of its own, so a data file arrives through Praat's Open > Read "
    ... + "from file... or Read Table from comma-separated file..."
endproc
