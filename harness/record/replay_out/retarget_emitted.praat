...
# range.
data1$ = "Table wt"   ; steps 1 (analysis), 2 (draw)
valueCol$   = "val"   ; the measured column -- steps 1 (analysis), 2 (draw)
factorACol$ = "grp"   ; the first factor -- step 1 (analysis)
factorBCol$ = "site"   ; the second factor -- step 1 (analysis)
groupCol$   = "grp"   ; the grouping column -- step 2 (draw)
