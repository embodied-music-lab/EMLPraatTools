...
#
# Table one was already open when this recording started.
...
data2$ = "Table twin"   ; run 2, step 2 (draw)
...
axisYMax2     = 0.0   ; on the recorded data this resolved to 13.0000 .. 18.5000; auto adapts to other data
...
Save as 300-dpi PNG file: "/home/claude/repo/harness/runblock/out/sametable/EDIT_step1.png"
