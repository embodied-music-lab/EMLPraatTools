...
Save as 300-dpi PNG file: "/home/claude/repo/harness/runblock/out/single/ORIG_step1.png"

@emlRecordStep: "save",
... "Save the outputs of this analysis",
... "Every output shares one folder and one name, so they stay a set.",
... "outputFolder$ = " + """" + "/home/claude/repo/harness/runblock/out/single/saved" + """" + newline$
...
@emlRecordFlush: "/home/claude/repo/harness/runblock/out/single/emitted.praat"
@emlRecordDiscard
