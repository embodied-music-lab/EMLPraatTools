...
procedure emlTestRequirePraat
    ...
    if praatVersion < .floor
        ...
        appendInfoLine: ""
        appendInfoLine: "  A bare `praat` may not be the right one. The"
        appendInfoLine: "  harness drivers resolve a supported build through"
        appendInfoLine: "  harness/_env.sh, which honours $PRAAT first; set"
        appendInfoLine: "  that to the binary you mean and re-run."
        appendInfoLine: ""
