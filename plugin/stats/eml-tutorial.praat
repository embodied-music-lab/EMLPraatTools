...
procedure emlTplTitleCard: .n
    ...
    .y = .y - titleStep
    @emlPlaceTitle: .y, pg'.n'_title$
    .y = emlPlaceTitle.nextY
    @emlPlaceAccent: .y, mL, titleSize
    .y = emlPlaceAccent.nextY
    @emlPlaceBodyLine: .y, pg'.n'_sub1$
    .y = emlPlaceBodyLine.nextY
    @emlPlaceBodyLine: .y, pg'.n'_sub2$
endproc
...
procedure emlTplTextPage: .n
    ...
    @emlPlaceAccent: .y, mL, headingSize
    .y = emlPlaceAccent.nextY
    @emlPlaceBody: .y, mB, 78, text$, pg'.n'_body$
    .y = emlPlaceBody.nextY
    @emlPlaceBody: .y, mB, 78, accent$, pg'.n'_keyQ$
endproc
...
procedure emlTplTextImage: .n
    ...
    # Text — right column
    @emlPlaceHeadingAt: .y, colR, pg'.n'_heading$
    .y = emlPlaceHeadingAt.nextY
    @emlPlaceAccent: .y, colR, headingSize
    .y = emlPlaceAccent.nextY
...
procedure emlTplCodePage: .n
    ...
    .codePad = bodyLineH * clearanceRatio
    .codeInset = mB - mL
    .codeLineStep = bodyLineH * stepRatio
    ...
    # Echo code to Info window for copying
    writeInfoLine: "# ", pg'.n'_heading$
    for .i from 1 to pg'.n'_nLines
        .lineText$ = pg'.n'_code'.i'$
