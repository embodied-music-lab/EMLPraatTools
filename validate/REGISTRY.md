...
**Expect exit status 0.** 8221 checks, all passing, plus 8 attestations
...
from the exit status, and are listed separately so that "8221 checks passed"
means 8221 things were tested.
