...
**Expect exit status 0.** 5500 checks, all passing, plus 8 attestations
...
from the exit status, and are listed separately so that "5500 checks passed"
means 5500 things were tested.
