...
**Expect exit status 0.** 6486 checks, all passing, plus 8 attestations
...
from the exit status, and are listed separately so that "6486 checks passed"
means 6486 things were tested.
